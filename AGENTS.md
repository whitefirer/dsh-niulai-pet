...
**连戳红温**：戳一下积 0.3 火气（heat），同一 90ms 拍里 0.006/拍消退（~15s 凉透，
快戳 4 下必爆）；视觉 = sepia+saturate 微红移 + 红色辉光（applyImgFilter 合成，
全皮肤通用不用画素材）；满格爆发一次：哼「再戳我急了！」+ 扭头背过去，
爆发即泄火，爆发中与点爆那戳都不演正常戳反应（=不理人）。
