...
**连戳红温**：戳一下积 0.3 火气（heat），同一 90ms 拍里 0.003/拍消退（~9s 才褪一半，
长演出角色也看得见红；快戳 4 下必爆）；视觉 = 轻度 sepia/saturate 暖化 + 红色辉光
+ **heatLayer 红色剪影层**（当前图作 alpha 蒙版 + `mix-blend-mode:color` 盖红——
只换色相保明暗，蓝皮也变"真红"而非平红膜；蒙版 90ms 拍里跟随 img.src，
分裂隐身时同步隐）；满格爆发一次：哼「再戳我急了！」+ 扭头背过去 +
4s 气头冷却（期间戳也白戳不理人）；**爆发不清火**，旧火按原速自然消退
（慢慢退红）。分裂克隆取红温快照（sepia/辉光进克隆滤镜）。
