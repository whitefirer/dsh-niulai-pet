...
+ **heatLayer 红色剪影层**（当前图作 alpha 蒙版盖纯红，opacity=heat×0.55——蓝皮
滤镜拉不红，靠它真变红；蒙版 90ms 拍里跟随 img.src，分裂隐身时同步隐）；满格爆发一次：
哼「再戳我急了！」+ 扭头背过去，爆发即泄火，爆发中与点爆那戳都不演正常戳反应
（=不理人）。分裂克隆取红温快照（sepia/辉光进克隆滤镜）。
